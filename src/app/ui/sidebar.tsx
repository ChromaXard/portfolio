    ...
    return (
      <>
        ...
        {isOpen ? (
          ...
          <ul>
          <li className="mb-3">
              <Link onClick={() => setIsOpen(false)} href="/">{translations('home')}</Link>
          </li>
          <li className="mb-3">
              <Link onClick={() => setIsOpen(false)} href="/about">À propos</Link>
          </li>
          <li className="mb-3">
              <Link onClick={() => setIsOpen(false)} href="/career">Parcours professionnel</Link>
          </li>
          <li className="mb-3">
              <div className="flex items-center justify-between">
              <Link onClick={() => setIsOpen(false)} href="/projects">Projets réalisés</Link>
              <button 
              ...
              <li>
                  <Link onClick={() => setIsOpen(false)} href="/projects/ft_transcendence">ft_transcendence</Link>
              </li>
              <li>
                  <Link onClick={() => setIsOpen(false)} href="/projects/ft_irc">ft_irc</Link>
              </li>
              </ul>
              </div>
          </li>
          <li className="mb-3">
            ...
            locale === "en" ? (
            <>
              <Link href={"/fr" + pathToAdd} onClick={() => { setIsOpen(false); }}>
            &#127467;&#127479;
              </Link>
            </>
            ) : (
            <>
              <Link href={"/en" + pathToAdd} onClick={() => { setIsOpen(false);}}>
            &#127468;&#127463;
              </Link>
            </>
          )
